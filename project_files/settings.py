...
SECRET_KEY = 'django-insecure-toxm@sz8poo*yj7a(no3(ug9&xx_3umtapxb)(38cv4_&($02l'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'application/templates/application/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = 'login'     # Redirect to login page if user try to access 'home/profile' page without been logged in.
